...
export default async function SellerEditProductPage({ params }: Props) {
  ...
  if (!user) {
    return <div className="mx-auto max-w-5xl px-4 py-10">Please log in first.</div>;
  }
  ...
  if (!profile || profile.role !== "seller") {
    return <div className="mx-auto max-w-5xl px-4 py-10">Seller access required.</div>;
  }
  ...
  if (!product) {
    return <div className="mx-auto max-w-5xl px-4 py-10">Product not found.</div>;
  }
